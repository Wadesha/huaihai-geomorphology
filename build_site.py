...
nav{position:sticky;top:0;z-index:50;background:var(--bg);border-bottom:1px solid var(--line);
  padding-bottom:10px}
.topbar{max-width:1000px;margin:0 auto;display:flex;align-items:center;gap:18px;height:50px;padding:0 22px;flex-wrap:wrap}
.topbar .brand{font-weight:700;font-size:15.5px;white-space:nowrap;border:0;letter-spacing:.02em}
...
.cards{max-width:1000px;margin:0 auto;padding:2px 22px 0;display:flex;gap:9px;flex-wrap:wrap}
.cards button{font-family:inherit;font-size:14.5px;line-height:1.4;color:var(--muted);
...
.cards.sub{padding-top:9px}
.cards.sub button{font-size:13.5px;padding:5px 13px;border-radius:8px}
.view{display:none}
.view.on{display:block}
main{padding-bottom:20px}
.hero{padding:40px 0 10px}
h1{font-size:29px;line-height:1.4;margin:0 0 .35em;letter-spacing:.01em}
